...
//! Project version number for JoyTalkSDK.
FOUNDATION_EXPORT double JoyTalkSDKVersionNumber;

//! Project version string for JoyTalkSDK.
FOUNDATION_EXPORT const unsigned char JoyTalkSDKVersionString[];
